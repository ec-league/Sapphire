 ...
 *
 * @author yunpeng.byp
 * @version $Id: StockDetailDto.java, v 0.1 2017年10月21日 下午7:57 yunpeng.byp Exp $
 */
public class StockDetailDto implements Dto {
    private String      code;
    private String      name;
    ...
    private MacdRiskDto macdRiskDto;

    public StockDetailDto(StockStatistics statistics) {
    ...
    /**
     * Getter method for property <tt>macdRiskDto</tt>.
     *
     * @return property value of macdRiskDto
     */
    public MacdRiskDto getMacdRiskDto() {
        return macdRiskDto;
    }

    /**
     * Setter method for property <tt>macdRiskDto</tt>.
     *
     * @param macdRiskDto  value to be assigned to property macdRiskDto
     */
    public void setMacdRiskDto(MacdRiskDto macdRiskDto) {
        this.macdRiskDto = macdRiskDto;
    }
}